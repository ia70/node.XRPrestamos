...
BEGIN
	...
	DEClARE curLista 
		...
		INNER JOIN cobro_dia AS d ON d.folio_credito = b.folio_credito INNER JOIN persona AS a ON a.ine = d.ine LEFT JOIN abono AS c ON c.folio_credito = d.folio_credito WHERE d.id_usuario = _usuario 
	...
	ciclo: LOOP
		...
		INSERT INTO ttcobrodia1 VALUES(var_folio_credito, var_ine, var_nombre, var_alias, var_telefono, var_monto_credito, var_pagos_total, var_monto_total, 
